...
//Write a program to display your name on the first line and to display your degree program on the second line on the screen. Please use command line (cmd) to execute your code
package com.mycompany.practicals;
public class Practicals 
{
    public static void main(String[] args) 
